...
questions_list.append(
        Question('Выбери верные утверждения', 'Глагол отвечает на вопросы что делать? что сделать?', 'Глагол – это член предложения.', 'Глагол – это часть слова.', 'Глагол – отвечает на вопросы Кто? Что?.'))
